...
uint8_t led_brightness_level_red = 0;
uint8_t led_brightness_level_green = 0;
uint8_t led_brightness_level_blue = 0;
uint8_t led_brightness_level_white = 0;
