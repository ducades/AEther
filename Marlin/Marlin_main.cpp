...
void serial2_echopair_P(const char *s_P, float v)
  { serial2printPGM(s_P); SERIAL2_ECHO(v); }
  ...
  if(code_seen('G'))
  {
    ...
    case 1: // G1
      if(Stopped == false) {
        ...
        //AEther
        Serial2_printlnxyz("G1 F", (next_feedrate * feedmultiply)/100, " X", current_position[X_AXIS], " Y", current_position[Y_AXIS], " Z", current_position[Z_AXIS], " E", current_position[E_AXIS]);
        Serial2_println("");
        Serial2_printlntemp("M104 S", degHotend(0));
        Serial2_println("");
        Serial2_printlntemp("M140 S", degBed());
        Serial2_println("");
        Serial2_printlntemp(";Hotend Temp= ", degHotend(1));
        Serial2_println("");
    ...
    case 4: // G4 dwell
      ...
      if(code_seen('P')) 
        ...
        //AEther
        Serial2_printlntemp("G4 P", code_value());
        Serial2_println("");
      if(code_seen('S')) codenum = code_value() * 1000; // seconds to wait
        //AEther
        Serial2_printlntemp("G4 S", (code_value()*1000);
        Serial2_println("");
